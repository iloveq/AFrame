...
import com.woaiqw.base.widget.LoadingView;
...
public class ProgressDialogUtils {
    ...
    private LoadingView pb_loadProgress;
    ...
    public ProgressDialogUtils(Context context, int style) {
        ...
        pb_loadProgress = (LoadingView) mDialogContentView.findViewById(R.id.pb_load_progress);
